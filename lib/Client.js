...
class Client {
    ...
    /**
     * This method retrieves information about the provided API key
     *
     * @param {function} callback - The callback function, if not provided {Promise} is returned
     * @returns {Promise|undefined} - undefined if callback defined, Promise if no callback
     */
    getKeyInfo(callback) {
        return this._request('key', null, 'key', callback);
    }
    ...
    findGuildByPlayer(player, callback) {
        return this._findGuild('byPlayer', player, callback);
    }
    ...
    getSession(player, callback) {
        return this._request('session', { player }, 'session', callback);
    }
